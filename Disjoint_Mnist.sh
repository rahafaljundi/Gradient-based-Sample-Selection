...
MY_PYTHON="python"
mkdir results/Disjoint_Mnist_5
cd data/
...
$MY_PYTHON main.py $MNIST_Split --model GSS_IQP_Rehearse --lr 0.05  --n_memories 100 --n_sampled_memories 300 --n_constraints 10 --memory_strength 0  --n_iter 3 --slack 0 --change_th 0.0 --repass 0 --eval_memory yes --normalize  no --seed 1 --subselect 0 --age 0 --memory_strength 0 --change_th 0.0
$MY_PYTHON main.py $MNIST_Split --model GSS_IQP_Rehearse --lr 0.05  --n_memories 100 --n_sampled_memories 300 --n_constraints 10 --memory_strength 0  --n_iter 3 --slack 0 --change_th 0.0 --repass 0 --eval_memory yes --normalize  no --seed 2 --subselect 0 --age 0 --memory_strength 0 --change_th 0.0
